...
onlyruca<-rucacodes[,c(4,5,6)]
colnames(onlyruca)<-c("tract_ID","ruca_prime","ruca_second")

# coerce tract_ID to character
onlyruca$tract_ID<-as.character(onlyruca$tract_ID)

# set to urban or not urban based on RUCA codes
onlyruca$urban<-'noturban'
onlyruca <- within(onlyruca, urban[ruca_second == 1.0 | ruca_second == 1.1 | ruca_second == 2.0 | ruca_second == 2.1 | ruca_second == 3.0 | ruca_second == 3.1 | ruca_second == 4.1 | ruca_second == 5.1 | ruca_second == 6.1 | ruca_second == 7.1 | ruca_second == 8.1 | ruca_second == 9.1 | ruca_second == 10.1] <- 'urban')
