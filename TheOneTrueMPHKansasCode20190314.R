...
ks_analysis_only_complete <- 
  ks_analysis_pop_indep[
    complete.cases(ks_analysis_pop_indep),]
# View(ks_analysis_only_complete)
...
# View(ks_analysis_populated_complete)
...
# 
# density_black <-
#   density(ks_analyze$black_percent_B03002_004_001*100)
# density_black_no_wells <-
#   density(ks_analyze$black_percent_B03002_004_001[
#     which(ks_analyze$extant_swd_binary == 0
#     )]*100)
...
# 
# par(mar=c(5,5,3,1))
# qqnorm(ks_analyze$black_percent_B03002_004_001*100,
#        col = 'orchid1',
#        pch = 18,
#        cex = 1,
#        main = "All Block Groups",
#        family = "Times New Roman")
# qqline(ks_analyze$black_percent_B03002_004_001[
#   which(ks_analyze$extant_swd_binary == 0)]*100,
#   lwd=2)
# 
# par(mar=c(5,5,3,1))
# qqnorm(ks_analyze$black_percent_B03002_004_001[
#   which(ks_analyze$extant_swd_binary == 0)]*100,
#   col = 'slateblue1',
#   pch = 18,
#   cex = 1,
...
ks_analyze$extant_swd_binary_text <- 
  "1+"
...
health_insurance_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$no_health_insurance_percent_B27010_017_033_050_066*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
lim_eng_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$limited_english_percent_C16002_004_007_010_013_001*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
renter_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$renter_occupy_percent_B25003_003_001*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
unemploy_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$unemployed_percent_B23025_005_003*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
poverty_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$poverty_below_100_percent_C17002_002_003_001*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
white_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$white_non_hisp_lat_percent_B03002_003_001*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
aian_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$aian_percent_any_race_B02010_001*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
hisp_lat_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$hisp_lat_percent_B03002_012_001*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
black_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$black_percent_B03002_004_001*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
female_boxplot <-
  ggplot(ks_analyze,
         aes(x = extant_swd_binary_text,
             y = ks_analyze$female_percent_B01001_026_001*100,
             fill = extant_swd_binary_text)) +
  geom_boxplot(alpha=0.7, fill = c("slateblue1", "springgreen1"),
               outlier.colour = NULL) +
...
#### t-tests all populated census tracts ####
...
#### t-tests with all populated census tracts ####
...
ks_analysis_populated_no_urban <- ks_analysis_populated %>% 
...
summary_statistics_no_urban <- ks_analysis_populated_no_urban %>% 
  select("ALAND_KM",
         "AWATER_KM",
         "pop_tot_B01001_001",
         "pop_dense_B01001_001_ALAND", 
...
summary_statistics_no_wells_no_urban <- 
  ...
  summarise_all(funs(oooo_min = min, 
                     ...
                     oooo_mean = mean, 
                     oooo_sd = sd), na.rm = TRUE)
# View(summary_statistics_no_wells_no_urban)
...
urban_tract_map <- ks_analysis_dataset %>% 
  select(GEOID, ruca_prime, ruca_second, urban_binary)

write.csv(urban_tract_map, file = "urban_tract_map.csv")

all_map <- ks_analysis_dataset

write.csv(all_map, file = "all_map.csv")
...
# total population
pop_wilcox <- 
  wilcox.test(ks_analyze$pop_tot_B01001_001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$pop_tot_B01001_001[
      which(ks_analyze$extant_swd_binary == 1)], 
              paired = FALSE, 
              alternative = "t")
pop_wilcox
...
# population density
pop_dense_wilcox <- 
  wilcox.test(ks_analyze$pop_dense_B01001_001_ALAND[
    which(ks_analyze$extant_swd_binary == 0)],  
    ks_analyze$pop_dense_B01001_001_ALAND[
                which(ks_analyze$extant_swd_binary == 1)],
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# native American
aian_wilcox <- 
  wilcox.test(ks_analyze$aian_percent_any_race_B02010_001[
    which(ks_analyze$extant_swd_binary == 0)],  
    ks_analyze$aian_percent_any_race_B02010_001[
                which(ks_analyze$extant_swd_binary == 1)],  
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# hisp/lat
hisp_lat_wilcox <- 
  wilcox.test(ks_analyze$hisp_lat_percent_B03002_012_001[
    which(ks_analyze$extant_swd_binary == 0)],
    ks_analyze$hisp_lat_percent_B03002_012_001[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# white
white_wilcox <- 
  wilcox.test(ks_analyze$white_non_hisp_lat_percent_B03002_003_001[which(ks_analyze$extant_swd_binary == 0)],
              ks_analyze$white_non_hisp_lat_percent_B03002_003_001[which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
white_wilcox
...
# age 0-17
age_18_wilcox <- 
  wilcox.test(ks_analyze$age_0_to_17_percent_B01001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$age_0_to_17_percent_B01001[
      which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# age 65+
age_65_wilcox <- 
  wilcox.test(ks_analyze$age_65_plus_percent_B01001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$age_65_plus_percent_B01001[
      which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# education
educ_wilcox <- 
  wilcox.test(ks_analyze$education_high_school_plus_percent_B15003_017_to_025[
    which(ks_analyze$extant_swd_binary == 0)], 
              ks_analyze$education_high_school_plus_percent_B15003_017_to_025[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# limited english
eng_wilcox <- 
  wilcox.test(ks_analyze$limited_english_percent_C16002_004_007_010_013_001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$limited_english_percent_C16002_004_007_010_013_001[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# no health insurance
health_ins_wilcox <- 
  wilcox.test(ks_analyze$no_health_insurance_percent_B27010_017_033_050_066[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$no_health_insurance_percent_B27010_017_033_050_066[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# renter
rent_wilcox <- 
  wilcox.test(ks_analyze$renter_occupy_percent_B25003_003_001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$renter_occupy_percent_B25003_003_001[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# unemployed
unemploy_wilcox <- 
  wilcox.test(ks_analyze$unemployed_percent_B23025_005_003[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$unemployed_percent_B23025_005_003[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# poverty
pov_wilcox <- 
  wilcox.test(ks_analyze$poverty_below_100_percent_C17002_002_003_001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$poverty_below_100_percent_C17002_002_003_001[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# earnings
earn_wilcox <- 
  wilcox.test(ks_analyze$earnings_median_B20002_001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$earnings_median_B20002_001[
      which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# household income
income_wilcox <- 
  wilcox.test(ks_analyze$income_house_median_B19013_001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$income_house_median_B19013_001[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
# home value
home_value_wilcox <- 
  wilcox.test(ks_analyze$house_value_median_B25077_001[
    which(ks_analyze$extant_swd_binary == 0)], 
    ks_analyze$house_value_median_B25077_001[
                which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
...
land_wilcox <- 
  wilcox.test(ks_analyze$ALAND_KM[which(ks_analyze$extant_swd_binary == 0)], 
              ks_analyze$ALAND_KM[which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
land_wilcox
...
# water area
water_wilcox <- 
  wilcox.test(ks_analyze$AWATER_KM[which(ks_analyze$extant_swd_binary == 0)], 
              ks_analyze$AWATER_KM[which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
water_wilcox
...
# horizontal well count
horiz_wilcox <- 
  wilcox.test(ks_analyze$horizontal_count[which(ks_analyze$extant_swd_binary == 0)], 
              ks_analyze$horizontal_count[which(ks_analyze$extant_swd_binary == 1)], 
              data = ks_analyze, 
              paired = FALSE, 
              alternative = "t")
horiz_wilcox
