...
lime_fluid_swd_horiz_ruca_prod_acs <- merge(lime_fluid_swd_horiz_ruca_prod,
                                  acs_geo_cats,
                                  by = "GEOID",
                                  all = TRUE)
...
#### replace NAs with 0s ####
# production
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         prod_count[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$prod_count)] <- 0)

# shale presence
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         shale_presence[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$shale_presence)] <- 0)

# total lifetime fluid injected
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         total_fluid[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$total_fluid)] <- 0)

# from 2010 fluid injected
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         from_2010_fluid[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$from_2010_fluid)] <- 0)

# all swd well count
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         all_swd_count[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$all_swd_count)] <- 0)

# extant swd well count
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         extant_swd_count[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$extant_swd_count)] <- 0)

# all swd wells from 2010 count
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         all_swd_from_2010_count[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$all_swd_from_2010_count)] <- 0)

# extant swd wells from 2010 count
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         extant_swd_from_2010_count[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$extant_swd_from_2010_count)] <- 0)

# horizontal well count
lime_fluid_swd_horiz_ruca_prod_acs <-
  within(lime_fluid_swd_horiz_ruca_prod_acs,
         horizontal_count[is.na(
           lime_fluid_swd_horiz_ruca_prod_acs$horizontal_count)] <- 0)
```
...
# make the variables
lime_fluid_swd_horiz_ruca_prod_acs$total_fluid_binary <- NA
lime_fluid_swd_horiz_ruca_prod_acs$from_2010_fluid_binary <- NA
lime_fluid_swd_horiz_ruca_prod_acs$horizontal_binary <- NA
lime_fluid_swd_horiz_ruca_prod_acs$all_swd_binary <- NA
lime_fluid_swd_horiz_ruca_prod_acs$extant_swd_binary <- NA
lime_fluid_swd_horiz_ruca_prod_acs$all_swd_from_2010_binary <- NA
lime_fluid_swd_horiz_ruca_prod_acs$extant_swd_from_2010_binary <- NA
lime_fluid_swd_horiz_ruca_prod_acs$prod_binary <- NA
...
```{r save the above}
# save/write chunk
save(lime_fluid_swd_horiz_ruca_prod_acs,
     file = "lime_fluid_swd_horiz_ruca_prod_acs.rdata")
write.csv(lime_fluid_swd_horiz_ruca_prod_acs,
          file = "lime_fluid_swd_horiz_ruca_prod_acs.csv")
...
lime_fluid_swd_horiz_ruca_prod_acs_analysis <-
  lime_fluid_swd_horiz_ruca_prod_acs[,c(
    "GEOID",
    "all_swd_count",
    "extant_swd_count",
    "all_swd_from_2010_count",
...
save(lime_fluid_swd_horiz_ruca_prod_acs_analysis,
     file = "lime_fluid_swd_horiz_ruca_prod_acs_analysis.rdata")
write.csv(lime_fluid_swd_horiz_ruca_prod_acs_analysis,
          file = "lime_fluid_swd_horiz_ruca_prod_acs_analysis.csv")
...
```{r logistic gam because I AM STUBBORN}
...
univariable_poisson_table_tibble <- 
  univariable_poisson_initial_tibble %>% 
  select(model, term, rate) %>%   # select relevant columns
  filter(term != "(Intercept)") %>%   # remove intercept rows
  mutate(model = as.character(model)) %>%   # make model a character vector
  select(model, rate)   # get rid of term
```
