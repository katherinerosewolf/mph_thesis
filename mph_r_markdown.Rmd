...
filter(!! sym(year_varname) == early_year)

naminator <- 
  function(glm_model) {
    name_of_model <- 
      deparse(substitute(glm_model))
    name_of_model_short <- 
      str_split(name_of_model, "\\$")[[1]][[1]]
  }
...
thing <- lapply(univariable_logistic_models_glm, naminator)

thing$pop_dense_B01001_001_ALAND

# make hl gof function
hl_gof_inator <- 
  function(glm_model, predictor_name) {
...
# make function to find the goodness of fit
