...
```{r big logistic model, eval=FALSE, include=FALSE}
...
exp(confint.default(logistic_female))
...
summary(logistic_model_revised_data)

# automated choice of best fit
logistic_matrix <- 
  data.matrix(logistic_model_revised_data$data)

View(logistic_matrix)

output_variable <- 
  complete_case_dataset$extant_swd_binary
...
stats::AIC(big_gam_k_5, logistic_model_revised_data)
