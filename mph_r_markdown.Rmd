...
ks_income_complete_main_vars_only <- 
  ks_analysis_all %>% 
  dplyr::select(GEOID, 
                extant_swd_binary, 
        pop_dense_hundreds_B01001_001_ALAND,  
...
save(ks_income_complete_main_vars_only, 
     file = "ks_income_complete_main_vars_only.rdata")
write.csv(ks_income_complete_main_vars_only, 
     file = "ks_income_complete_main_vars_only.csv")
```
...
load(file = "ks_income_complete_main_vars_only.rdata")
...
```{r big logistic regressions, eval=FALSE, include=FALSE}
...
logistic_model_revised_full <- 
   stats::glm(extant_swd_binary ~ 
        ...
        prod_count + 
        AWATER_KM, 
      data = ks_income_complete_main_vars_only, 
      family = binomial)
...
logistic_model_extant_swd_binary_at_end <- 
  ks_income_complete_main_vars_only %>% 
  dplyr::select(-extant_swd_binary, 
         everything())
...
# logistic model with best AIC
logistic_model_revised_best_AIC <- 
   stats::glm(extant_swd_binary ~ 
        pop_dense_hundreds_B01001_001_ALAND + 
        female_true_percent_B01001_026_001 + 
        unemployed_true_percent_B23025_005_003 + 
...
spatial_residuals <- 
  tibble(GEOID = ks_income_complete_main_vars_only$GEOID, 
    residuals = residual_best_aic, 
            longitude = ks_income_complete_main_vars_only$INTPTLON, 
            latitude = ks_income_complete_main_vars_only$INTPTLAT)
...
nrow(ks_income_complete_main_vars_only)
