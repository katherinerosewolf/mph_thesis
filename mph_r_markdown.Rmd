...
lime_fluid_swd_horiz_ruca_prod_acs <- 
  lime_fluid_swd_horiz_ruca_prod_acs %>% 
  mutate(
    pop_tot_thousands_B01001_001 = 
      pop_tot_B01001_001 / 1000,
    pop_dense_thousands_B01001_001_ALAND = 
      pop_dense_B01001_001_ALAND / 1000,
    age_0_to_17_true_percent_B01001 = 
      age_0_to_17_percent_B01001 * 100,
    age_65_plus_true_percent_B01001_big = 
      age_65_plus_percent_B01001 * 100,
    white_non_hisp_lat_true_percent_B03002_003_001_big = 
      white_non_hisp_lat_percent_B03002_003_001 * 100,
    hisp_lat_true_percent_B03002_012_001_big = 
      hisp_lat_percent_B03002_012_001 * 100,
    black_true_percent_B03002_004_001_big = 
    ...
    earnings_median_thousands_B20002_001 = 
      earnings_median_B20002_001 / 1000,
    income_house_median_thousands_B19013_001 = 
      income_house_median_B19013_001 / 1000,
    house_value_median_thousands_B25077_001 = 
      house_value_median_B25077_001 / 1000,
...
univariable_logistic_models_glm <-
  sapply(dependent_variable_names, 
         function(x) {
...
thing<-lrm(extant_swd_binary ~ pop_dense_B01001_001_ALAND + prod_count + prod_count * pop_dense_B01001_001_ALAND,
        data = ks_analysis_populated, 
        x = TRUE, y = TRUE)


hi <- anova(thing, indnl = TRUE)
print(hi, "subscripts")
...
height         <- rnorm(n, 50, 10)
cholesterol    <- rnorm(n, 200, 25)
sex            <- factor(sample(c('female','male'), n,TRUE))


f <- lrm(cholesterol ~ age + rcs(blood.pressure,5) + sex + rcs(height,4))
...
univariable_logistic_models_lrm <-
  lapply(dependent_variable_names, 
         lrm_function)
...
```{r logistic regression goodness of fit statistics}
...
thing <- anova(univariable_logistic_models_lrm$pop_tot_B01001_001, indnl = TRUE)
summary(thing)
...
thing <- rms::anova(univariable_logistic_models_lrm$pop_tot_B01001_001)
summary(thing)
...
# make list of tibbles with cis
profile_ci_list <- 
  lapply(univariable_logistic_models_glm, profilinator)
