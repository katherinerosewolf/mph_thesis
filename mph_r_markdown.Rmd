...
thing <- 
  lrm(extant_swd_binary ~ pop_dense_B01001_001_ALAND + prod_count + prod_count * pop_dense_B01001_001_ALAND, 
      data = ks_analysis_populated, 
      x = TRUE, y = TRUE)
...
univariable_profile_ci_tibble <- 
  univariable_profile_ci_tibble %>% 
  rename(profile_ci_or_low = conf.low, 
...
univariable_wald_ci_est_tibble <- 
  univariable_wald_ci_est_tibble %>% 
  rename(wald_ci_est_low = conf.low, wald_ci_est_high = conf.high)
```
...
univariable_wald_ci_tibble <- 
  univariable_wald_ci_tibble %>% 
  rename(wald_ci_or_low = conf.low, wald_ci_or_high = conf.high)
```
...
univariable_profile_ci_est_tibble <- 
  univariable_profile_ci_est_tibble %>% 
  rename(profile_ci_est_low = conf.low, 
...
residuals.lrm(univariable_logistic_models_lrm)
class(univariable_logistic_models_lrm)
View(univariable_logistic_models_lrm)
...
logistic_matrix <- 
  data.matrix(logistic_model_revised_data)
