...
thing<-lrm(extant_swd_binary ~ pop_dense_B01001_001_ALAND + house_value_median_B25077_001 + pop_dense_B01001_001_ALAND * house_value_median_B25077_001,
        data = ks_analysis_populated, 
        x = TRUE, y = TRUE)

hi <- anova.rms(thing, indnl = TRUE)
print(hi, "subscripts")
...
# remove ice
dependent_variable_names_no_ice <- 
  c("pop_tot_B01001_001", 
    "pop_dense_B01001_001_ALAND", 
    "female_percent_B01001_026_001", 
    "age_0_to_17_percent_B01001", 
...
hl_gof_list <- 
  as.list(data.frame(hl_gof_matrix))
