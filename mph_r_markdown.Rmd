...
# run all the univariable logistic regressions AT ONCE (MWAHAHA)
univariable_logistic_models <-
...
names(univariable_logistic_models) <- 
  dependent_variable_names

# makes table of estimate, standard error, statistic, and p-value
initial_coefficients <- 
  plyr::ldply(univariable_logistic_models, 
              tidy, 
              .id = "model")
...
wald_ci_list <- 
  lapply(univariable_logistic_models, waldinator)
...
univariable_wald_ci_tibble <- 
  univariable_wald_ci_tibble %>% 
  rename(wald_ci_low = conf.low, wald_ci_high = conf.high)
```


```{r profile confidence intervals}
...
# make list of tibbles with cis
profile_ci_list <- 
  lapply(univariable_logistic_models, profilinator)
...
univariable_profile_ci_tibble <- 
  univariable_profile_ci_tibble %>% 
  rename(profile_ci_low = conf.low, 
         profile_ci_high = conf.high)
