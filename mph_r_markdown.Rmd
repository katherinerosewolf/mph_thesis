...
```{r ADD AUTO OUTPUT OTHER PLOTS qq and density plots populated block groups, echo=TRUE}
...
univariable_logistic_models <-
  sapply(small_dependent_variables, function(x) {
...
all_coefficients <- 
  plyr::ldply(univariable_logistic_models, tidy, .id = "model")
head(all_coefficients)
class(all_coefficients)
...
univariable_logistic_estimates <-             # 
  sapply(univariable_logistic_model_function, tidy)
univariable_cute_estimates <-                 # 
  sapply(univariable_logistic_estimates, kable)
