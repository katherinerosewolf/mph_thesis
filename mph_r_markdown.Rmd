...
```{r qq and density plots, eval=FALSE, include=FALSE}
...
```{r box plots, eval=FALSE, include=FALSE}
#### box plots ####
...
```{r levene tests, eval=FALSE, include=FALSE}
...
```{r urban chi-square tests, eval=FALSE, include=FALSE}
#### chi-square tests
...
```{r t tests income-only census block groups, eval=FALSE, include=FALSE}
