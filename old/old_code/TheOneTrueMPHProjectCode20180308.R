...
#####
# # well data -- need to do more work here to establish eligible wells
# welldata<-read.csv("WellsTableDispInjSWInjSalt2018-03-08.CSV")
# View(welldata)
...
# wellACSjoin<-read.csv("WellsJoinedToBGsForR.txt")
...
allACS2016data<-dtm21

# final data file here (12.7 GB)
save(allACS2016data,file="allACS2016data.rdata")
save(BG_METADATA_2016_data_table,file="BG_METADATA_2016_data_table")

load(file="allACS2016data.rdata")
load(file="BG_METADATA_2016.rdata")

# run to here 2018-03-13

# View variable names
View(BG_METADATA_2016)

View(ACS2016dataexportmergefinal$B15003e1)
View(X15_EDUCATIONAL_ATTAINMENT$B15003e1)
...
# View 
View(ACS2016dataexportmergefinal[1:10])

# pull total population
# B01001e1 total
# B01001e2 male
# B01001e3 
totalpopulation<-ACS2016dataexportmergefinal[,c("GEOID","B01001e1")]
sex<-ACS2016dataexportmergefinal[,c("GEOID","B01001e2","B01001e26")]
sexcatbyage<-ACS2016dataexportmergefinal[,c("GEOID","B01001e3","B01001e4","B01001e5","B01001e6","B01001e7","B01001e8","B01001e9","B01001e10","B01001e11","B01001e12","B01001e13","B01001e14","B01001e15","B01001e16","B01001e17","B01001e18","B01001e19","B01001e20","B01001e21","B01001e22","B01001e23","B01001e24","B01001e25","B01001e27","B01001e28","B01001e29","B01001e30","B01001e31","B01001e32","B01001e33","B01001e34","B01001e35","B01001e36","B01001e37","B01001e38","B01001e39","B01001e40","B01001e41","B01001e42","B01001e43","B01001e44","B01001e45","B01001e46","B01001e47","B01001e48","B01001e49")]
medianage<-ACS2016dataexportmergefinal[,c("GEOID","B01002e1","B01002e2","B01002e3")]
race<-ACS2016dataexportmergefinal[,c("GEOID","B03002e1","B03002e2","B03002e3","B03002e4","B03002e5","B03002e6","B03002e7","B03002e8","B03002e9","B03002e10","B03002e11","B03002e12","B03002e13","B03002e14","B03002e15","B03002e16","B03002e17","B03002e18","B03002e19","B03002e20","B03002e21")]
educationalattainment<-ACS2016dataexportmergefinal[,c("GEOID","B15003e1","B15003e2","B15003e3","B15003e4","B15003e5","B15003e6","B15003e7","B15003e8","B15003e9","B15003e10","B15003e11","B15003e12","B15003e13","B15003e14","B15003e15","B15003e16","B15003e17","B15003e18","B15003e19","B15003e20","B15003e21","B15003e22","B15003e23","B15003e24","B15003e25")]
povertyratio<-ACS2016dataexportmergefinal[,c("GEOID","C17002e1","C17002e2","C17002e3","C17002e4","C17002e5","C17002e6","C17002e7","C17002e8")]
incomehouseholdcat<-ACS2016dataexportmergefinal[,c("B19001e1","B19001e2","B19001e3","B19001e4","B19001e5","B19001e6","B19001e7","B19001e8","B19001e9","B19001e10","B19001e11","B19001e12","B19001e13","B19001e14","B19001e15","B19001e16","B19001e17")]
incomehouseholdmedian<-ACS2016dataexportmergefinal[,c("GEOID","B19013e1")]
earningsbysex<-ACS2016dataexportmergefinal[,c("GEOID","B20001e1","B20001e2","B20001e3","B20001e4","B20001e5","B20001e6","B20001e7","B20001e8","B20001e9","B20001e10","B20001e11","B20001e12","B20001e13","B20001e14","B20001e15","B20001e16","B20001e17","B20001e18","B20001e19","B20001e20","B20001e21","B20001e22","B20001e23","B20001e24","B20001e25","B20001e26","B20001e27","B20001e28","B20001e29","B20001e30","B20001e31","B20001e32","B20001e33","B20001e34","B20001e35","B20001e36","B20001e37","B20001e38","B20001e39","B20001e40","B20001e41","B20001e42","B20001e43")]
medianearnings<-ACS2016dataexportmergefinal[,c("GEOID","B20002e1","B20002e2","B20002e3")]
employmentstatus<-ACS2016dataexportmergefinal[,c("GEOID","B23025e1","B23025e2","B23025e3","B23025e4","B23025e5","B23025e6","B23025e7")]
homevalue<-ACS2016dataexportmergefinal[,c("GEOID","B25075e1","B25075e2","B25075e3","B25075e4","B25075e5","B25075e6","B25075e7","B25075e8","B25075e9","B25075e10","B25075e11","B25075e12","B25075e13","B25075e14","B25075e15","B25075e16","B25075e17","B25075e18","B25075e19","B25075e20","B25075e21","B25075e22","B25075e23","B25075e24","B25075e25","B25075e26","B25075e27")]
healthinsurance<-ACS2016dataexportmergefinal[,c("GEOID","B27010e1","B27010e2","B27010e3","B27010e4","B27010e5","B27010e6","B27010e7","B27010e8","B27010e9","B27010e10","B27010e11","B27010e12","B27010e13","B27010e14","B27010e15","B27010e16","B27010e17","B27010e18","B27010e19","B27010e20","B27010e21","B27010e22","B27010e23","B27010e24","B27010e25","B27010e27","B27010e28","B27010e29","B27010e30","B27010e31","B27010e32","B27010e33","B27010e34","B27010e35","B27010e36","B27010e37","B27010e38","B27010e39","B27010e40","B27010e41","B27010e42","B27010e43","B27010e44","B27010e45","B27010e46","B27010e47","B27010e48","B27010e49","B27010e50","B27010e51","B27010e52","B27010e53","B27010e54","B27010e55","B27010e56","B27010e57","B27010e58","B27010e59","B27010e60","B27010e61","B27010e62","B27010e63","B27010e64","B27010e65","B27010e66")]

# merge all of the above together
View(sexcatbyage)

allnecessaryACSdata<-totalpopulation[sex,on="GEOID"][sexcatbyage,on="GEOID"][medianage,on="GEOID"][race,on="GEOID"][educationalattainment,on="GEOID"][povertyratio,on="GEOID"][incomehouseholdcat,on="GEOID"][incomehouseholdmedian,on="GEOID"][earningsbysex,on="GEOID"][medianearnings,on="GEOID"][employmentstatus,on="GEOID"][homevalue,on="GEOID"][healthinsurance,on="GEOID"]



View(educationalattainment)
gc()
